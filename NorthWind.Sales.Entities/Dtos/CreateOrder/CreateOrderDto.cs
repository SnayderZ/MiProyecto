...
//public class CreateOrderDto(string customerId, string shipAddress, string shipCity, string shipCountry, string shipPostalCode, IEnumerable<CreateOrderDetailDto> oderDetails)
//{
...
//    public IEnumerable<CreateOrderDetailDto> OrderDetail => oderDetails;
//}
#endregion
...
//    private IEnumerable<CreateOrderDetailDto> _oderDetails;

//    public CreateOrderDto(string customerId, string shipAddress, string shipCity, string shipCountry, string shipPostalCode, IEnumerable<CreateOrderDetailDto> oderDetails)
//    {
...
//    public IEnumerable<CreateOrderDetailDto> createOrderDetails { get { return _oderDetails; } }
//}
#endregion
...
public class CreateOrderDto
{
    ...
    public IEnumerable<CreateOrderDetailDto> createOrderDetails { get; private set; }
    ...
    public CreateOrderDto(string customerId, string shipAddress, string shipCity, string shipCountry, string shipPostalCode, IEnumerable<CreateOrderDetailDto> oderDetails)
    {
        ...
        createOrderDetails = oderDetails;
    }
}
#endregion
